    ...
    <SafeAreaView style={styles.safe} edges={["bottom"]}>
      ...
      >
        ...
        <Section title="4. Driver Obligations and Representations">
          <Para>If you use the Platform as a Driver, you represent, warrant, and agree that
          at all times while operating a vehicle in connection with a Poolyn-coordinated trip:</Para>
          ...
          <SubSec title="4.3 Insurance — Critical Obligation">
            <Text style={styles.bold}>This is one of the most important obligations in these Terms.</Text> You must:
          </SubSec>
          <BulletList items={[
        ...
        <Section title="7. Prohibited Conduct">
          <Para>The following conduct is strictly prohibited and may result in immediate account
          suspension, permanent termination, reporting to relevant authorities, and/or legal action:</Para>
          <BulletList items={[
        ...
        <View style={styles.noticeBox}>
          <Text style={styles.noticeTitle}>Legal Review Required</Text>
