  ...
  return (
    <>
      ...
      >
            ...
            <View style={[styles.heroInner, { paddingHorizontal: contentPad }]}>
              <View style={styles.badgeRow}>
                <View style={styles.badge}>
                  <Ionicons name="shield-checkmark-outline" size={15} color={Landing.tealVivid} />
                  <Text style={styles.badgeText}>Verified professionals</Text>
                </View>
                <View style={styles.badge}>
                  <Ionicons name="leaf-outline" size={15} color={Landing.tealVivid} />
        ...
        {/* Final CTA */}
        <LinearGradient
          colors={LandingGradients.finalBand}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
...
const styles = StyleSheet.create({
  ...
  heroTitleAccent: { color: Landing.tealVivid },
  heroSub: {
  ...
  featCardHi: {
    ...
    ...Platform.select({
      web: { boxShadow: LandingWebShadow.forestCard } as object,
      default: {},
    }),
  },
  featTitle: {
  ...
  diffCard: {
    ...
    borderColor: Landing.tealLine,
    ...Platform.select({
      web: { boxShadow: LandingWebShadow.cardLift } as object,
      default: Shadow.md,
    }),
  },
  ...
  outcomeCard: {
    ...
    borderColor: Landing.tealLine,
    ...Platform.select({
      web: { boxShadow: LandingWebShadow.cardFloat } as object,
      default: Shadow.sm,
    }),
  },
  ...
  impactTitleAccent: { color: Landing.tealVivid },
  impactSub: {
    fontFamily: LandingFont.body,
    fontSize: FontSize.lg,
