...
export function buildPassengerPaymentExplainerMessage(opts: {
  ...
  const creditsBlock =
    "Poolyn Credits: when a passenger completes a trip, the driver receives Credits matching the passenger’s trip share. When you ride later, those Credits can cover your own trip share; any separate cash service fee still applies unless your workplace network covers it.";
